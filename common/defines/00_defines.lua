...
NProduction = {
	...
	BASE_FACTORY_SPEED = 5.0, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_MIL = 3.50, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NBuildings = {
	...
	MAX_SHARED_SLOTS = 40,				-- Max slots shared by factories
